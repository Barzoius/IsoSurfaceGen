            ...
            for (int x = 0; x < gridSize; x++)
            {
                for (int y = 0; y < gridSize; y++)
                {
                    for (int z = 0; z < gridSize; z++)
                    {
                        ...
                        //Vector3 cellMin = voxelCenter - Vector3.one * (voxelSize / 2f);
                        //Vector3 cellMax = voxelCenter + Vector3.one * (voxelSize / 2f);

                        
                        //vertexPos = Vector3.Max(cellMin, Vector3.Min(vertexPos, cellMax));
